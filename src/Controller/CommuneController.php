...
{
    /**
     * @Route("/communes", name="commune", methods={"GET"})
     * @OA\Response(
     *     response=200,
     *     description="Returns all commune in front",
     * )
     * @OA\Tag(name="Commune")
     */
     ...
     * @OA\Response(
     *     response=200,
     *     description="Returns all commune",
     *     @OA\JsonContent(
     *        type="array",
    ...
    public function communeCreate(Request $request)
    {
        ...
        $response->setContent('Saved new commune with id ' . $newCommune->getId() . ' the name of commune is ' . $newCommune->getNom());
        return $response;
    }
